...
//
// By default we are using 3 colums plus whatever's entered by the user:
 ...
 */
export function logTime(spreadsheetId, start, end, who, what) {
 ...
 */
export function createSpreadsheet(name, fields) {
  return gapi.client.sheets.spreadsheets.create(createLogTemplate(name, fields)).then(response => {
